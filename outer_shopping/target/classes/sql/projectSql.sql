...
CREATE TABLE OUTER_PICTURE (
	...
	PICTURE_NAME VARCHAR(100) NOT NULL, /* 사진 이름 */
	OUTER__NO NUMBER(10) NOT NULL, /* 아웃터 번호 */
	CONSTRAINT OUTER_PICTURE_O_NO_FK FOREIGN KEY(OUTER_NO) REFERENCES OUTER_TB ON DELETE CASCADE
);
...
CREATE SEQUENCE PRODUCT_NO INCREMENT BY 1 START WITH 1;
   ...
   SELECT * FROM USER_SEQUENCES WHERE SEQUENCE_NAME = UPPER('ORDER_NO');
